...
async def stop_agent():
    ...
    try:
        ...
        # Return UI updates
        return (
            gr.update(v639975a81ab90f19e3588e5e3f4a2a146879c0e18a8a659242cd86a84585d0ee="Stopping...", interactive=False),  # stop_button
        ...
        return (
            gr.update(label="Stop", interactive=True),
    ...
    with gr.Blocks(
        ...
        with gr.Tabs() as tabs:
            ...
            with gr.TabItem("🤖 Run Agent", id=4):
                ...
                with gr.Row():
                    run_button = gr.Button("▶️ # The above code is a comment in Python. Comments are
                    # used to provide explanations or notes within the code
                    # for better understanding. In this case, the comment
                    # says "Run Agent", which is likely a reminder or
                    # instruction for someone reading the code. Comments
                    # are ignored by the Python interpreter and do not
                    # affect the execution of the code.
                    Run Agent", variant="primary", scale=2)
